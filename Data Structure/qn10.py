#10. String, List, & Dictionary: Given a paragraph, count the frequency of each word (case-insensitive)
#  and return a dictionary where the keys are the words and the values are their frequencies.
