#19. Set & Dictionary: Given a dictionary of words as keys and their definitions as values,
#  return a set containing all the words whose definitions contain a specific keyword.
